        ...
        <div id='content'>
            <div class='panel panel-default'>
                ...
                <div class='panel-body' align="center">
                    <form class="inline" role="form" action="case_reg_connect.php" method="POST" enctype="multipart/form-data">
                        <div class="col-sm-9">
                            <h4 align="center"> <b> <u>Registration</u> </b></h4>
                            <br>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text"class="form-control" name="caseno" placeholder="Casenumber" required>
                                </div>
                                <div class="col-sm-2 form-group">
                                    <label> Court: </label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class='col-sm-4 form-group'>
                                    <select class="form-control" name="activity">
                                        <option> Assessment of Costs/Taxation </option>
                                        <option> Bail </option>
                                        <option> Bond </option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="party" placeholder="Party(s) involved">
                                </div>
                            </div>
                            <br>
