                ...
                <div class="container-fluid">
                    ...
                    <div class="menu">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation" class="active"><a href="register.php">Amendment</a></li>
    ...
    <div id="page-inner">
        ...
        <div class="container">
            ...
            <div class="col-lg-8 well" style="background-color: #d2ee4a">
                <div class="row">
                    <center>
                        <form class="inline" role="form" action="amend_connect.php" method="POST" enctype="multipart/form-data">
                            <div class="col-sm-12">
                                <h4 align="center"> <b> <u> Other Application </u> </b></h4>
                                <br>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text"class="form-control" value="<?php echo $casen ?>" name="caseno" placeholder="P&A" required readonly>
                                    </div>
