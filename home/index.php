...
<body>
  ...
  <div class="container">
          <center>
              <form class="inline" role="form" action="search.php" method="POST" enctype="multipart/form-data">
              <div class="col-sm-4 form-group">
                  <input type="text" class="form-control" name="case" placeholder="Case number">
              </div>
              <div class="col-sm-2 form-group">
              <button type="submit" name="submit" class="form-control btn btn-success glyphicon glyphicon-search">Search</button>
              </div>
              <div class="col-sm-2 form-group">
