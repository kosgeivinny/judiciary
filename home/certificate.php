...
<div class="container">
    ...
    if (isset($_POST['submit'])) {
        ...
        <div class='container'>
                    ...
                    <center>
                        <form class='inline' role='form' action='certificate_connect.php' method='POST' enctype='multipart/form-data'>
                            <center>
                            <div class='col-sm-8' style='background-color:greenyellow'>
                                <h4 align='center'> <b> <u> CERTIFICATE OF CONFIRMATION OF GRANT(FORM 54)</u> </b></h4>
                                <br>
                                <br>
                                <div class='row'>
                                ...
                                <div class='row' >
                                    ...
                                    <div class='col-sm-3' >
                                        <input type = 'text'class='form-control' name = 'dateissued' value='$date'>
                                    </div >
                                </div >
                                <br >
