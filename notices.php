                    ...
                    <center>
                        <form class="inline" role="form" action="notices_connect.php" method="POST" enctype="multipart/form-data">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label> <?php echo $_SESSION['case']; ?> </label>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <label class="col-sm-8">
                                        <div class="col-lg-12 checkbox" align="left">
                                            <label class="checkbox"><input type="checkbox" value="chief" name="chief" required>  <b> LOCAL CHIEF'S LETTER</b>  </label> <br>
                                            <label class="checkbox"><input type="checkbox" value="form80" name="form80" required>  <b> FORM 80</b> (PETITION) </label>  <br>
                                            <label class="checkbox"><input type="checkbox" value="form5" name="form5" required> <b>FORM 5</b> (AFFIDAVIT IN SUPPORT OF PETITION) </label> <br>
                                            <label class="checkbox"><input type="checkbox" value="form12" name="form12" required> <b>FORM 12</b> (AFFIDAVIT OF MEANS BY PETITIONER) </label> <br>
                                            <label class="checkbox"><input type="checkbox" value="form38" name="form38"> <b>FORM 38</b> (CONSENT) </label> <br>
                                            <label class="checkbox"><input type="checkbox" value="form57" name="form57" required> <b>FORM 57</b> (GUARANTEE) </label> <br>
                                            <label class="checkbox"><input type="checkbox" value="form11" name="form11" required> <b>FORM 11</b> (FORM 11) </label> <br>
                                        </div>
